        ...
        <el-form-item>
          <div class="clearfix">
            ...
            <el-button type="text" style="float: right;"
              @click="$router.replace({ path: '/resetpassword' })">找回密码</el-button>
            <el-button v-if="loginConfig.allowRegister" type="text" style="float: right; margin-right: 10px;"
              @click="$router.replace({ path: '/register' })">免费注册</el-button>
          </div>
          ...
          <el-button :loading="loading" type="primary" size="medium" style="width: 100%;"
            @click.native.prevent="fakeLogin">
            <span v-if="!loading">假 登 录</span>
          </el-button>
